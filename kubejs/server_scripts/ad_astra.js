ServerEvents.recipes(event => {
  let transostrumtank = 'kubejs:incomplete_ostrum_tank'
  let transostrumengine = 'kubejs:incomplete_ostrum_engine'
  ...
  event.shaped(
    Item.of('ad_astra:space_helmet', 1), // arg 1: output
    [ 
      '   ', 
  ...
  event.shaped(
    Item.of('ad_astra:steel_block', 1), 
    [ 
      'AAA', 
      'AAA', 
      'AAA'  
