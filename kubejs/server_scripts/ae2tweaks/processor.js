...
//printed processor
  e.recipes.create.sequenced_assembly([
	...
	e.recipes.create.sequenced_assembly([
		Item.of('ae2:printed_silicon').withChance(50),
		Item.of('ae2:silicon').withChance(25),
		Item.of('create:chromatic_compound').withChance(15),
		Item.of('minecraft:sand').withChance(10),
	], 'ae2:silicon', [ 
		e.recipes.createCutting(transprintedsilicon, transprintedsilicon),
        e.recipes.createDeploying(transprintedsilicon, [transprintedsilicon, 'kubejs:radiant_sheet']),
          e.recipes.createDeploying(transprintedsilicon, [transprintedsilicon, 'kubejs:radiant_coil']).keepHeldItem(),
            e.recipes.createPressing(transprintedsilicon, transprintedsilicon)
	]).transitionalItem(transprintedsilicon).loops(5)
  e.recipes.create.sequenced_assembly([
