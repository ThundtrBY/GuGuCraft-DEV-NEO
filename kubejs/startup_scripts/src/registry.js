...
StartupEvents.registry('item', e =>{
  ...
  e.create('lootbag_create_andesite').displayName('工程师补给（安山）')
...
StartupEvents.registry('block', e =>{
  e.create('sheldonite_ore'). displayName('铂矿石')
          .soundType('nether_ore')
          .requiresTool(true)
          .tagBlock("mineable/pickaxe")
          .tagBlock('minecraft:needs_iron_tool')
  e.create('andesite_machine'). displayName('安山机械装置')
          .notSolid()
          .renderType('solid')
  e.create('brass_machine'). displayName('黄铜机械装置')
          .soundType('lantern').notSolid()
          .renderType('translucent')
  e.create('supercritical_machine').displayName('超临界机械装置')
          .notSolid()
          .renderType('cutout')
          .hardness(3.0)
  e.create('train_machine').displayName('列车机械装置')
          .soundType('lantern')
          .notSolid()
          .renderType('cutout')
          .hardness(3.0)
  e.create('reinforced_glass').displayName('高密度防爆玻璃')
          .soundType('glass')
          .notSolid()
          .renderType('cutout')
          .resistance(1200)
          .hardness(20.0)
          .tagBlock("mineable/pickaxe")
  e.create('incomplete_reinforced_glass').displayName('高密度防爆玻璃(半成品)')
          .soundType('glass')
          .notSolid()
          .renderType('cutout')
  e.create('ingot_mold').displayName('锭铸模')
          .soundType('lantern')
          .notSolid()
          .renderType('cutout')
          .box(5, 0, 3, 11, 4, 13, true)
  e.create('molten_steel_ingot_mold').displayName('熔融钢铸模')
          .soundType('lantern')
          .notSolid()
          .renderType('cutout')
          .box(5, 0, 3, 11, 4, 13, true)
