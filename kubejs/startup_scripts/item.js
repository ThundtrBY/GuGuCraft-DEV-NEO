...
StartupEvents.registry('item', e =>{
  ...
  e.create('fireclay_ball').displayName('耐火粘土球')
  e.create('fireproof_brick').displayName('耐火砖')
})
StartupEvents.registry('block', e =>{
  ...
  e.create('reinforced_glass').displayName('高密度防爆玻璃').soundType('glass').notSolid().renderType('cutout').resistance(1200).hardness(20.0).tagBlock("mineable/pickaxe").tagBlock('minecraft:needs_diamond_tool')
  ...
  e.create('fireproof_bricks').displayName('耐火砖块').soundType('nether_bricks').hardness(3.0).resistance(6.0).tagBlock("mineable/pickaxe")
  e.create('blast_furnace').displayName('TEMP0')
  e.create('furnace_fluid_output').displayName('TEMP1')
  e.create('furnace_item_input').displayName('TEMP2')
})